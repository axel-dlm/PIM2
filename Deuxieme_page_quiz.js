      ...
      <div className="rectangle-container">
        <div className="rectangle">
          <header className="App-header">
            ...
            <p className="text_2">
            Quelle plante grimpe et change de couleur ?
            </p>
            <button className="button1">Basilic</button>
            <button className="button2">Vigne vierge</button>
            <button className="button3">  Pissenlit</button>
          </header>
